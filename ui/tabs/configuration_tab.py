...
# ==============================================================================
# PHASE 24 UPDATE: 
# FIX: Added stretch factors and maximum heights to the main layout to prevent 
#      the bottom control bar from expanding and consuming 50% of the screen.
# ==============================================================================
...
class ConfigurationTabBuilder:
    ...
    def build(ui):
        ...
        # --- Bottom Commit Bar ---
        bottom_bar = QWidget()
        # FIXED: Enforced a strict maximum height so the layout engine can't stretch it.
        bottom_bar.setMaximumHeight(65)
        ...
        ui.btn_import_xml = QPushButton("IMPORT XML")
        ui.btn_import_xml.setStyleSheet("""
            QPushButton {
        ...
        ui.btn_export_xml = QPushButton("EXPORT XML")
        ui.btn_export_xml.setStyleSheet("""
            QPushButton {
        ...
        ui.btn_save_srv_settings = QPushButton("COMMIT SETTINGS TO SERVER")
        ...
        bottom_layout.addWidget(ui.btn_import_xml)
        bottom_layout.addWidget(ui.btn_export_xml)
        ...
        # FIXED: Added stretch=1 to the content area, forcing the bottom bar down.
        real_main_layout.addWidget(holder_widget, stretch=1)
        real_main_layout.addWidget(bottom_bar, stretch=0)
